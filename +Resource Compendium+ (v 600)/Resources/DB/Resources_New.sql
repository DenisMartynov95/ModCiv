...
VALUES	('AMBER',			2,			'GAIA_RESOURCE_ATLAS',		0),
		...
		('JADE',			2,			'GAIA_RESOURCE_ATLAS',		3),
		('LAPIS',			2,			'GAIA_RESOURCE_ATLAS',		4),
...
VALUES	('IMPROVEMENT_FISHING_BOATS',	'RESOURCE_GAIA_CORAL',		'YIELD_PRODUCTION',		1),
		...
		('IMPROVEMENT_QUARRY',			'RESOURCE_GAIA_JADE',		'YIELD_PRODUCTION',		2),
		('IMPROVEMENT_QUARRY',			'RESOURCE_GAIA_JADE',		'YIELD_GOLD',			10),
